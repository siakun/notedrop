...
tags:
  ...
  - m2
  - handoff
summary: M1 완료 후 새 세션에서 M2 (Infrastructure 통합 + BRAT 배포) 를 컨텍스트 손실 없이 시작하기 위한 프롬포트 + 결정 사항 박제
---
# Notedrop M2 핸드오프

새 Claude Code 세션 첫 입력으로 통째로 붙여넣기.
...
- README BRAT 설치 안내
- ADR-0025 (manifest.json repo root 위치 결정 박제)
